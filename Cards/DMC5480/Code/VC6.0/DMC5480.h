...
//相对螺旋插补运动函数
DMC5480_API  DWORD  __stdcall d5480_rel_helix_move(WORD card, WORD* axisList, long *rel_pos,long *rel_cen, long height, WORD 

arc_dir);
//绝对螺旋插补运动函数
DMC5480_API  DWORD  __stdcall d5480_helix_move(WORD card, WORD* axisList, long *target_pos,long *cen_pos,long height, WORD 
