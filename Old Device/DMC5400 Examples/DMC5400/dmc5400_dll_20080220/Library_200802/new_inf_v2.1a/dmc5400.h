...
void __stdcall d5400_set_board_isr(void (__stdcall * MyIsr )(void));

void __stdcall d5400_set_int_factor(WORD axis, DWORD int_factor);

//void __stdcall d5400_link_interrupt(WORD CardNo, void(__stdcall *callbackAddr)(WORD IntAxisNoInCard));
