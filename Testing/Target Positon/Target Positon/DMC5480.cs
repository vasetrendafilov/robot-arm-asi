...
namespace csDmc5480
{
	...
	// Initial function	
        ...
        public static extern UInt16  d5480_board_init();
       ...
       //[DllImport("DMC5480.dll", EntryPoint = "d5480_get_config_latch_mode", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        public static extern UInt32  d5480_config_ERC_PIN(UInt16 axis,UInt16 enable,UInt16 erc_logic, UInt16 erc_width,UInt16 erc_off_time);
        ...
        public static extern UInt32  d5480_get_config_ERC_PIN(UInt16 axis,ref UInt16 enable,ref UInt16 erc_logic, ref UInt16 erc_width,ref UInt16 erc_off_time);
	
        [DllImport("DMC5480.dll", EntryPoint = "d5480_config_EMG_PIN", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_config_EMG_PIN(UInt16 cardno, UInt16 enable, UInt16 emg_logic);
	    ...
	    [DllImport("DMC5480.dll", EntryPoint = "d5480_config_EL_MODE", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_config_EL_MODE(UInt16 axis, UInt16 el_logic, UInt16 el_mode);
	    ...
	    [DllImport("DMC5480.dll", EntryPoint = "d5480_set_HOME_PIN_logic", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_set_HOME_PIN_logic(UInt16 axis,UInt16 org_logic,UInt16 filter);
        ...
        public static extern int  d5480_read_inbit(UInt16 cardno, UInt16 bitno);
	...
	//State detection function
        ...
        public static extern UInt16   d5480_check_done(UInt16 axis) ;
        ...
        public static extern UInt32  d5480_reset_target_position(UInt16 axis,long dist);
	...
	//Software limit function
        ...
        public static extern UInt32  d5480_config_softlimit(UInt16 axis,UInt16 ON_OFF, UInt16 source_sel,UInt16 SL_action, long N_limit,long P_limit);
        ...
        public static extern UInt32  d5480_get_config_softlimit(UInt16 axis,ref UInt16 ON_OFF,ref UInt16 source_sel,ref UInt16 SL_action,ref long N_limit,ref long P_limit);
	...
	//Speed setting
        ...
        public static extern UInt32  d5480_set_position(UInt16 axis,long current_position);
	...
	[DllImport("DMC5480.dll", EntryPoint = "d5480_reset_clear_flag", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        //Speed setting, Linear interpolation function
	...
	[DllImport("DMC5480.dll", EntryPoint = "d5480_read_vector_speed", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        public static extern UInt32  d5480_line2(UInt16 axis1,long Dist1,UInt16 axis2,long Dist2,UInt16 posi_mode);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_line3", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_line3(ref UInt16 axis,long Dist1,long Dist2,long Dist3,UInt16 posi_mode);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_line4", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_line4(UInt16 cardno,long Dist1,long Dist2,long Dist3,long Dist4,UInt16 posi_mode);

	//Single axis motion control function
	
        [DllImport("DMC5480.dll", EntryPoint = "d5480_set_profile", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_set_profile(UInt16 axis,double Min_Vel,double Max_Vel,double acc,double dec);
        ...
        public static extern UInt32  d5480_get_profile(UInt16 axis,ref double Min_Vel,ref double Max_Vel,ref double acc,ref double dec);
	...
	[DllImport("DMC5480.dll", EntryPoint = "d5480_pmove", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        public static extern UInt32  d5480_arc_move(ref UInt16 axis,ref long target_pos,ref long cen_pos, UInt16 arc_dir);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_rel_arc_move", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_rel_arc_move(ref UInt16 axis,ref long rel_pos,ref long rel_cen, UInt16 arc_dir);

	//Spiral interpolation function
	
	    [DllImport("DMC5480.dll", EntryPoint = "d5480_rel_helix_move", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_rel_helix_move(UInt16 card,ref UInt16 axisList,ref long rel_pos,ref long rel_cen,long height, UInt16 arc_dir);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_helix_move", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_helix_move(UInt16 card,ref UInt16 axisList,ref long target_pos,ref long cen_pos,long height, UInt16 arc_dir);
        ...
        public static extern UInt32  d5480_compare_add_point(UInt16 card, long pos, UInt16 dir,  UInt16 action, long actpara);
        ...
        public static extern long d5480_compare_get_current_point(UInt16 card);
        ...
        public static extern long  d5480_compare_get_points_runned(UInt16 card);
        ...
        public static extern long d5480_compare_get_points_remained(UInt16 card);
        ...
        public static extern long  d5480_get_encoder(UInt16 axis);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_set_encoder", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32  d5480_set_encoder(UInt16 axis,long encoder_value);
	...
	//Position latch related
        ...
        public static extern long  d5480_get_latch_value(UInt16 axis);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_get_latch_flag", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern long  d5480_get_latch_flag(UInt16 cardno);
        ...
        public static extern UInt32   d5480_conti_lines(UInt16 axisNum, ref UInt16 piaxisListw, ref long pPosList, UInt16 posi_mode);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_conti_arc", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32   d5480_conti_arc(ref UInt16 axis, ref long rel_pos, ref long rel_cen, UInt16 arc_dir,  UInt16 posi_mode);
        ...
        public static extern UInt32  d5480_conti_read_current_mark(UInt16 card);
        ...
        public static extern UInt32   d5480_conti_extern_lines(UInt16 axisNum, ref UInt16 piaxisListw, ref long pPosList, UInt16 posi_mode, long imark);

        [DllImport("DMC5480.dll", EntryPoint = "d5480_conti_extern_arc", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        public static extern UInt32   d5480_conti_extern_arc(ref UInt16 axis, ref long rel_pos, ref long rel_cen, UInt16 arc_dir,UInt16 posi_mode, long imark);
